...
public class EditSpinner extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mColor = a.getColor(R.styleable.EditSpinner_dropDownTextColor, Color.BLACK);
    ...
    public class CustomListAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view = inflater.inflate(android.R.layout.simple_spinner_dropdown_item,null,true);

            CheckedTextView txtTitle = view.findViewById(android.R.id.text1);
