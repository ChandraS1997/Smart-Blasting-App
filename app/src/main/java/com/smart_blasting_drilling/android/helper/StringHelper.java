...
//	}
    ...
    public static String setProductPrice(String price) {
        if (isEmpty(price))
            return "0.00";
       // return new DecimalFormat("0.00", symbols).format(Double.parseDouble(price));
        //formatDouble(Double.parseDouble(price));
        return price;
    ...
    public static boolean validateDoubleVal(String val) {
        boolean isNumber = validateNumberVal(val);
        if (!isNumber) {
