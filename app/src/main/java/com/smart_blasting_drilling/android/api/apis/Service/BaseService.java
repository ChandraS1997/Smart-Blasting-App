...
//        if (retrofit == null) {
        ...
        if (baseUrl.equalsIgnoreCase(Constants.API_BLADES_URL) || baseUrl.equalsIgnoreCase(Constants.API_IMAGE_VIDEO_BASE_URL) || baseUrl.equalsIgnoreCase(Constants.TEST_BLAST_S_BLAST_BASE_URL)) {
